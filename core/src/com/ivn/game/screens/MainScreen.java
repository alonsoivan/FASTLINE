...
*/
        ...
        VisTextButton playButton = new VisTextButton("2 JUGADORES");
...
*/
        ...
        VisTextButton configButton = new VisTextButton("1 JUGADOR");
        configButton.addListener(new ClickListener() {
            @Override
            public void clicked(InputEvent event, float x, float y) {
                ((Game) Gdx.app.getApplicationListener()).setScreen(new SingleGameScreen());
                dispose();
            }
        });
